...
public class LevelThree {
    ...
    static final private String[] character = {"h","k","r","n","e","o"};
    static final private String[] correctAnswer = {"her", "hen", "hoe", "hon", "kore", "knew", "know", "kohe", "kone", "korn", "hero", "kero", "heron", "hike", "hiker", "hone", "honer", "core", "knore", "ore"};

    public LevelThree(int previousScore) {
    ...
    private void end(Scanner input) {
        System.out.println();

        if (this.getLevelScore() > 70) {
            System.out.println("\nOverall score : " + this.getAccumulateScore());
